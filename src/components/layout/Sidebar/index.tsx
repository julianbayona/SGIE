...
const Sidebar: React.FC = () => {
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-neutral-800 text-white flex flex-col z-40 border-r border-stone-200/20">
      <div className="text-3xl italic font-headline text-primary-gold px-4 py-6">CB</div>
      <div className="px-4 py-2 mt-2">
        <p className="text-stone-500 text-[10px] uppercase tracking-widest font-medium">Event Management</p>
      </div>
      ...
      <div className="p-4 border-t border-stone-700/30">
        <div className="flex items-center gap-3">
          ...
          <div className="overflow-hidden">
            ...
            <p className="text-stone-500 text-[10px] truncate">Admin</p>
          </div>
        </div>
      </div>
    </aside>
