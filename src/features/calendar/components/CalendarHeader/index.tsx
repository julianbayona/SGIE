  ...
  return (
    <div className="flex items-center justify-between p-4 border-b border-outline-variant/10">
      <div className="flex items-center gap-4">
        <h2 className="font-serif-italic text-xl text-primary-gold capitalize">{getTitle()}</h2>
        <div className="flex items-center gap-2">
          <div className="flex bg-surface-container-low p-0.5 rounded">
            <Button variant="ghost" size="sm" onClick={handlePrev}>
              <span className="material-symbols-outlined text-sm">chevron_left</span>
            </Button>
            <Button variant="ghost" size="sm" onClick={handleToday} className="px-3 text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">
              Hoy
            </Button>
